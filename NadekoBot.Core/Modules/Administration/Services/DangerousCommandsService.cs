...
DELETE FROM CurrencyTransactions WHERE Reason='Gift' OR Reason='Claimed Waifu';";
...
DELETE FROM CurrencyTransactions Where UserId={0} AND (Reason='Gift' OR Reason='Claimed Waifu');";
