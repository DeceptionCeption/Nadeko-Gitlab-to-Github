...
namespace Nadeko.Microservices {
  public static partial class SearchImages
  {
    ...
    [grpc::BindServiceMethod(typeof(SearchImages), "BindService")]
    ...
    public partial class SearchImagesClient : grpc::ClientBase<SearchImagesClient>
    {
      ...
      public SearchImagesClient(grpc::ChannelBase channel) : base(channel)
      {
      }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, SearchImagesBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_Boobs, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.BoobsRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Boobs));
      serviceBinder.AddMethod(__Method_Butts, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.ButtsRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Butts));
      serviceBinder.AddMethod(__Method_Danbooru, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Danbooru));
      serviceBinder.AddMethod(__Method_Rule34, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Rule34));
      serviceBinder.AddMethod(__Method_Yandere, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Yandere));
      serviceBinder.AddMethod(__Method_Gelbooru, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Gelbooru));
      serviceBinder.AddMethod(__Method_Hentai, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Hentai));
      serviceBinder.AddMethod(__Method_SafeBooru, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.SafeBooru));
      serviceBinder.AddMethod(__Method_Konachan, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.Konachan));
      serviceBinder.AddMethod(__Method_DerpiBooru, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.DerpiBooru));
      serviceBinder.AddMethod(__Method_E621, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.TagRequest, global::Nadeko.Microservices.UrlReply>(serviceImpl.E621));
      serviceBinder.AddMethod(__Method_ToggleBlacklistTag, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.BlacklistTagMessage, global::Nadeko.Microservices.BlacklistTagReply>(serviceImpl.ToggleBlacklistTag));
      serviceBinder.AddMethod(__Method_GetBlacklsitedTags, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.GetBlacklistedTagsMessage, global::Nadeko.Microservices.GetBlacklistedTagsReply>(serviceImpl.GetBlacklsitedTags));
      serviceBinder.AddMethod(__Method_ClearCache, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Nadeko.Microservices.ClearCacheRequest, global::Nadeko.Microservices.ClearCacheReply>(serviceImpl.ClearCache));
    }
